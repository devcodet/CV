...
function Expirences() {
  ...
  var imagesGrid = getGridCircleImages([
    [
      ...
      {
        src: freeCodeCampMeetings,
        title: t("FreeCodeCampMeetings"),
        description: "",
      },
      {
        src: gdgLisbonDevFest2019,
        title: "GDG Lisbon Dev Fest 2019",
        description: "",
      },
      {
        src: gdgPortugalDevFest2020,
        title: "GDG Portugal Dev Fest 2020",
        description: "",
      },
    ],
    [
    ...
    [
      ...
      {
        src: restart,
        title: "Desafio Restart by Jorge Coutinho",
        description: "",
      },
  ...
  var featuresItems = getListFeatureItem([
    {
      title: "Toastmasters",
      description: t("ToastmastersDescription"),
      src: toastMasters,
    },
    {
      title: t("YouthGroupTitle"),
      description: t("YouthGroupDescription"),
      src: youthGroup,
    },
    {
      title: "Geek Sessions",
      description: t("GeekSessionDescription"),
      src: geekSessions,
    },
  ]);
  ...
  return (
    <div className="App-header page">
      ...
      <div style={{ margin: "auto" }}>{imagesGrid}</div>
      {featuresItems}
    </div>
  );
}
